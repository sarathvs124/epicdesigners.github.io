...
const Service = () => {
  return (
    <>
      <div id="service">
        <section className="pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px] bg-gray-100">
          <div className="container mx-auto">
            ...
            <div className="-mx-4 flex flex-wrap">
              <ServiceCard
                title="PLANNING"
                details="We plan everything from the beginning to make sure things go smoothly. Our services cover everything and are well thought out in advance."
                icon={
                  <svg
                    width="36"
                    height="36"
              ...
              <ServiceCard
                title="ARCHITECTURE"
                details="We can create designs that suit your requirements. Just let us know what you need, and we'll design it accordingly."
                icon={
                  <svg
                    width="36"
                    height="36"
              ...
              <ServiceCard
                title="INTERIORS"
                details="We bring together the right elements in interior designing to make a house a stylish home for you and your loved ones"
                icon={
                  <svg
                    width="36"
                    height="36"
              ...
              <ServiceCard
                title="LANDSCAPES"
                details="We attend to detail at every step of the way to create beautiful spaces that compliment your home or place of work."
                icon={
                  <svg
                    width="36"
                    height="36"
              ...
              <ServiceCard
                title="CONSULTANCY"
                details="We offer Consultancy services in the execution of the buildings to meet the best quality in a streamlined manner to achieve timely completion."
                icon={
                  <svg
                    width="36"
                    height="36"
